...
var words = [['escalera'], ['zapatilla'], ['computadora'], ['cargador'], ['pachanga'], ['fabuloso'], ['habilozo'], ['jabalina'], ['macanuda'], ['obelisco'], ['quebrada'], ['ubicados'], ['vagancia'], ['casa']];
var word = '';
var hidden_letter = [];
...
function try_letter(letter) {
    ...
    if(word.indexOf(letter) != -1) {
        ...
        document.getElementById("image").src = 'img/hangman_'+count_fails+'.jpg';
    }
